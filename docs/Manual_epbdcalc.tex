...
\makeatletter
\def\ps@portada{%
\def\@oddhead{\includegraphics[height=1.17cm]{mfom}\hfill \includegraphics[height=1.17cm]{ietcc}~\includegraphics[height=1.17cm]{csic2}}
\def\@evenhead{\includegraphics[height=1.17cm]{mfom}\hfill \includegraphics[height=1.17cm]{ietcc}~\includegraphics[height=1.17cm]{csic2}}
%\let\@oddhead\@empty%
%\let\@evenhead\@empty%
...
\fancyhead[L]{\includegraphics[height=1.17cm]{mfom}}
\fancyhead[R]{\hfill \includegraphics[height=1.17cm]{ietcc}~\includegraphics[height=1.17cm]{csic2}\\
...
\pagestyle{fancy}
\fancyhf{}
\lhead{\includegraphics[height=1.17cm]{mfom}}
\rhead{\hfill \includegraphics[height=1.17cm]{ietcc}~\includegraphics[height=1.17cm]{csic2}\\
\scshape \tiny Instituto de Ciencias de la Construcción Eduardo Torroja
}
...
\VerbatimInput[frame=lines, rulecolor=\color{gray}]{../pyepbd/examples/ejemplo1base_salida.csv}
...
\VerbatimInput[frame=lines, rulecolor=\color{gray}]{../pyepbd/examples/ejemplo1base.csv}
...
\VerbatimInput[frame=lines, rulecolor=\color{gray}]{../pyepbd/examples/ejemplo1PV.csv}
...
\VerbatimInput[frame=lines, rulecolor=\color{gray}]{../pyepbd/examples/ejemplo1PV_salida.csv}
...
\VerbatimInput[frame=lines, rulecolor=\color{gray}]{../pyepbd/examples/ejemplo1xPV.csv}
...
\VerbatimInput[frame=lines, rulecolor=\color{gray}]{../pyepbd/examples/ejemplo1xPV_salida.csv}
...
\VerbatimInput[frame=lines, rulecolor=\color{gray}]{../pyepbd/examples/ejemplo2PVgas.csv}
...
\VerbatimInput[frame=lines, rulecolor=\color{gray}]{../pyepbd/examples/ejemplo2PVgas_salida.csv}
...
\VerbatimInput[frame=lines, rulecolor=\color{gray}]{../pyepbd/examples/ejemplo3PVBdC.csv}
...
\VerbatimInput[frame=lines, rulecolor=\color{gray}]{../pyepbd/examples/ejemplo3PVBdC_salida.csv}
...
\VerbatimInput[frame=lines, rulecolor=\color{gray}]{../pyepbd/examples/ejemplo4cgnfosil.csv}
...
\VerbatimInput[frame=lines, rulecolor=\color{gray}]{../pyepbd/examples/ejemplo4cgnfosil_salida.csv}
...
\VerbatimInput[frame=lines, rulecolor=\color{gray}]{../pyepbd/examples/ejemplo5cgnbiogas.csv}
...
\VerbatimInput[frame=lines, rulecolor=\color{gray}]{../pyepbd/examples/ejemplo5cgnbiogas_salida.csv}
...
\VerbatimInput[frame=lines, rulecolor=\color{gray}]{../pyepbd/examples/ejemplo6K3.csv}
...
\VerbatimInput[frame=lines, rulecolor=\color{gray}]{../pyepbd/examples/ejemplo6K3_salida.csv}
